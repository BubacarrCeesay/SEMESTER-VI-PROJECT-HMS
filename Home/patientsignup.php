...
if(isset($_POST['signup'])){
    ...
    if($pwd != $cpwd){
        ...
        $query="INSERT INTO patient(firstname,lastname,email,phonenumber,age,gender,address,username,password,regdate)
    ...
    <main class="appointment">
        ...
        <section class="form">
          <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <br/><br/><br/>
            <input id="subapp" type="submit" name="signup" value="SIGN UP">
          </form>
