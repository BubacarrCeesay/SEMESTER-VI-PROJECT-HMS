  ...
  <body>
    ...
    <div id="headernav">
        <ul>
          ...
          <li><a class="activeh" href="appointment.php">Appointment</a></li>
    ...
    <main class="appointment">
        ...
        <section class="form">
          <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <label>
              <i class="fa-regular fa-calendar-days"></i>  <input id="numval" type="date" name="apdate" required>
            </label>
            <br/><br/><br/>
            <span>Appointment Time : </span><br/>
            <label>
              <i class="fa-regular fa-clock"></i>  <input id="numval" type="time" name="aptime" required>
            </label>
            <br/><br/><br/>
            <span>Appointment Reason (Symptoms): </span><br/>
            <textarea name="apreason" placeholder="Appiontment Reason (Medical Conditon)" required></textarea>
        
            <br/><br/><br/>
            <span>Medical History : </span><br/>
            <textarea name="med" placeholder="Medical History(If Any) "></textarea>
            <br/><br/><br/>
            <input id="subapp" type="submit" name="submitapp" value="BOOK">
          </form>

          <h4>Already have an account <a href="../Patient/patientlogin.php">Click Here To Login</a></h4>
        </section>
    </main>
...
if(isset($_POST['submitapp'])){
    ...
    if($pwd != $cpwd){
        ...
        $query="INSERT INTO appointment(firstname,lastname,email,username,phonenumber,age,gender,address,appdate,apptime,apreason,medicalhistory,datebook) 
        VALUES ('$fname','$lname','$email','$uname','$pnum','$age','$gender','$add','$apdate','$aptime','$apreason','$med',NOW())";

        $result=mysqli_query($con,$query);

        if($result){

            $q=mysqli_query($con,"INSERT INTO patient(firstname,lastname,email,phonenumber,age,gender,address,username,password,regdate)
         VALUES ('$fname','$lname','$email','$pnum','$age','$gender','$add','$uname','$pwd',NOW())");

          if($q){
            echo"<script>alert('Appointment Booked Succesfuly...!');</script>";
            echo"<script>alert('You Can Login To Know Your Appointment Status...!');</script>";
          }
