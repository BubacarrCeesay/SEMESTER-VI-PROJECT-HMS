...
if(isset($_POST['reset']))
{
  ...
  $result=mysqli_query($con, $query);
    ...
    if($cpassword != $password){
        ...
        $q="update admin set password='$password' where username='$username'";
            ...
            <div class="form">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                    ...
                    <br/>
                        ...
                        <a href="adminlogin.php"><input id="backbtn" type="button" name="back" value="BACK TO LOGIN"></a>
                </form>
