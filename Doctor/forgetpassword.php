...
if(isset($_POST['reset']))
{
  ...
  $query="select * from doctor where username='$username' and email='$email'";
  ...
  $result=mysqli_query($con, $query);
    ...
    if($cpassword != $password){
        ...
        $q="update doctor set password='$password' where username='$username'";
  ...
  <body>
    ...
    <main class="plogin">
        <section class="container" id="reset">
            <div class="up">
               <img src="../Patient/unlock.webp" alt="">
            ...
            <div class="form">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                    ...
                    <br/>
                        ...
                        <a href="doctorlogin.php"><input id="backbtn" type="button" name="back" value="BACK TO LOGIN"></a>
                </form>
