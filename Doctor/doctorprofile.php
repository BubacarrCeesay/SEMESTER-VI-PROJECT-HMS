...
if(isset($_POST['update'])){
    ...
    $qr="update doctor set profile='$profile' where username='$doc'";
...
if(isset($_POST['chname'])){
    ...
    $qr="update doctor set firstname='$newfname' where username='$doc'";
...
if(isset($_POST['chlname'])){
    ...
    $qr="update doctor set lastname='$newlname' where username='$doc'";
...
if(isset($_POST['chemail'])){
    ...
    $qr="update doctor set email='$email' where username='$doc'";
...
if(isset($_POST['chpnum'])){
    ...
    $qr="update doctor set phonenumber='$pnum' where username='$doc'";
...
if(isset($_POST['chuser'])){
    ...
    $qr="update doctor set username='$newuser' where username='$doc'";

    $res=mysqli_query($con,$qr);

    if($res){

        $_SESSION['doctor']=$newuser;
...
if(isset($_POST['chpass'])){
    ...
    $fetchpass=mysqli_query($con,"select * from doctor where username='$doc'");
    ...
    if($oldpass != $old){
        ...
        $qr="update doctor set password='$newpass' where username='$doc'";
...
if(isset($_POST['chaddress'])){
    ...
    $qr="update doctor set address='$add' where username='$doc'";
